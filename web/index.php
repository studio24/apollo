...
<header class="island island--fullpage bg bg--primary" style="background-image: url(/assets/images/production/apollo.png); background-repeat: no-repeat; background-position: 175% 42%;">
        ...
        <div class="group">
            <div class="group__item">
                ...
                <p>Our content is contained within Elements. Elements are the
                    smallest building blocks of the interface, such as buttons
                    or links.</p>
            ...
            <div class="group__item">
                ...
                <p>Components are groups of Elements or Components joined
                    together to form distinct sections of an interface, for
                    example navigation or comment blocks.</p>
            ...
            <div class="group__item">
                ...
                <p>Groups of Components are called Templates. Most pages are
                    created by choosing a Templates, some allow you to choose
                    Components as well and then completing the page with
                    content.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <div class="lead">
                    <p>Discover how to save money, time and better maintain your
                        brand consistency across platforms by using a living
                        content- and style guide.</p>
                    <p>A style guide is a living document of code, which details
                        all the various elements and coded modules of your site
                        or application. Beyond its use in consolidating the
                        front-end code, it also documents the visual language,
                        such as header styles and color palettes, used to create
                        the site.</p>
                </div>
    ...
    <section>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <div class="lead">
                    <p>The web is 95% typography and copy, which is why we spend
                        95% of our time thinking about the words we use to
                        express our brand.</p>
                </div>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>We treat accessible and inclusive design as a first-class
                    passenger making sure our website is accessible and usable
                    for everyone.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <p>Accessible and inclusive design isn't about people with
                    disabilities, it's about everybody. People like me and you.
                    Because people of all ethnicities, ages and abilities
                    benefit from inclusive design.</p>

                <p>Disabilities affect us daily and can range from someone
                    having a permanent disability, such as cognitive, vision, or
                    mobility-related disability; or they may be temporary, such
                    as someone with a broken arm; or even situational, such as a
                    parent holding their newborn.</p>

                <p>By designing with accessibility and inclusive design in mind
                    we are making sure that our website is available to as many
                    people as possible.</p>

                <p>The <a href="https://www.w3.org/TR/WCAG20/">WCAG 2.0 AA
                        compliance guidelines</a> are just the beginning. By
                    exploring the various ways a person can touch, tap, press,
                    swipe, click, hear, see and interact with our interfaces, we
                    build inclusive products to meet any disability, whether
                    they are permanent, temporary or situational.</p>
        ...
        <div class="group">
            ...
            <div class="group__item group__item--primary">
                ...
                <p>Consistency of color is critical to maintaining a coherent
                    family of products, and accurately communicating the nature
                    of specific content within an application.</p>
                <p>Colors also have a functional impact on readability,
                    eye-strain, ability to attract attention.</p>
                ...
                <ul class="clean-list swatches">
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Rhino
                            Blue</h4>
                        <p>
                            rgb(245, 130, 31)<br> #27354F<br> Pantone Solid
                            Coated 716 C
                        </p>
                    </li>
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Blaze
                            Orange</h4>
                        <p>
                            rgb(72, 184, 216)<br> #ff6600<br> Pantone Solid
                            Coated 2985 C
                        </p>
                    </li>
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Orange
                            Peel</h4>
                        <p>
                            rgb(68, 68, 68)<br> #ff9900<br> Pantone Solid Coated
                            Black 7 C
                        </p>
                    </li>
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Jacarta
                            Purple</h4>
                        <p>
                            rgb(242, 242, 242)<br> #F2F2F2<br> Pantone Solid
                            Coated 663 C
                        </p>
                    </li>
                </ul>
                ...
                <ul class="clean-list swatches">
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Mercury Grey
                            (Subtle)</h4>
                        <p>
                            rgb(245, 130, 31)<br> #F5821F<br> Pantone Solid
                            Coated 716 C
                        </p>
                    </li>
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Wild Sand
                            White</h4>
                        <p>
                            rgb(72, 184, 216)<br> #48b8d8<br> Pantone Solid
                            Coated 2985 C
                        </p>
                    </li>
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Mine Shaft
                            Black</h4>
                        <p>
                            rgb(68, 68, 68)<br> #444444<br> Pantone Solid Coated
                            Black 7 C
                        </p>
                    </li>
                    <li class="swatch">
                ...
                <ul class="clean-list swatches">
                    ...
                    <li class="swatch">
                        ...
                        <h4 class="heading size--l swatch__heading">Pomegranate
                            (Alert)</h4>
                        <p>
                            rgb(72, 184, 216)<br> #f04618<br> Pantone Solid
                            Coated 2985 C
                        </p>
                    </li>
                </ul>
            ...
            <div class="group__item group__item--primary">
                ...
                <div class="lead">
                    <p>Your content is contained within Elements. Elements are
                        the smallest building blocks of the interface, such as
                        buttons or inputs. They also include more abstract
                        elements like colour palettes, typography, and
                        interactive states.</p>
                </div>
    ...
    <section>
        ...
        <div class="group">
            ...
            <div class="group__item group__item--primary">
                ...
                <a href="link" class="button button--secondary">Secondary
                    button</a> <a href="link" class="button button--tertiary">Tertiary
                    button</a> <a href="link" class="button button--accent">Accent
                    button</a> <a href="link" class="button button--subtle">Subtle
                    button</a>

                <a href="link" class="button button--primary"> <span>Button with icon</span>
                    <svg class="icon">
                ...
                <a href="link" class="button button--primary button--is-block">
                    ...
                    <span>Block button with icon</span> </a>
                ...
                <p>
                    <a href="link" class="button button--success">Success
                        button</a>
                    <a href="link" class="button button--warning">Warning
                        button</a> <a href="link" class="button button--alert">Alert
                        button</a>
                </p>
                ...
                <a href="javascript(void);" class="button button--primary">Link
                    (styled as button)</a> <span class="button button--primary">Span</span>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Heading element is used for displaying our content's
                    headings.</p>
                <p>We keep our headings under 65 characters (including spaces)
                    so that they can be displayed for search engine results.</p>

            </div>
            <div class="group__item group__item--primary">

                <p>A well-defined information hierarchy is essential for a user
                    to find their way around a website. One important factor in
                    creating this hierarchy is the use of distinct header styles
                    that help the user make sense of the content being
                    presented.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Lead element is used for displaying a summary of the page
                    our visitors is about to read. On most templates this follow
                    the H1 heading.</p>
                <p>We keep our lead concise and under 140 characters (including
                    spaces) so that it can be displayed for search engine
                    results as the meta description.</p>

            </div>
            <div class="group__item group__item--primary">

                <div class="lead">
                    <p>The Adventures of Sherlock Holmes is a compilation of
                        twelve short stories that was published on 1892 and
                        written by Sir Arthur Conan Doyle.</p>
                </div>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Link element is used for displaying content that links
                    from one place to another.</p>
                <p>Instead of writing, &ldquo;Click here,&rdquo; we always write
                    descriptive texts explaining the destination. This way
                    people aren&rsquo;t frustrated by links leading them places
                    they didn&rsquo;t want to go.</p>

            </div>
            <div class="group__item group__item--primary">


                <h5 class="size size--xl heading subheading">Example of good
                    links</h5>
                ...
                <p>
                    <a href="javascript:void(0)">
                        ...
                        <span>Call Sherlock Holmes</span> </a>
                </p>


                <h5 class="size size--xl heading subheading">Example of bad
                    links</h5>
                <p>
                    <a href="javascript:void(0)">Click here</a>
                </p>
                <p>&ldquo;Click here,&rdquo; is instructive instead of
                    descriptive and tells people what they should be doing
                    instead of telling them where a link will take them.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Paragraph elements are used for displaying our content.
                    The ideal standard is no more than 20 words per sentence,
                    five sentences per paragraph.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <p>To Sherlock Holmes she is always the woman. I have seldom
                    ...
                    eclipses and predominates the whole of her sex. It was not
                    that he felt any emotion akin to love for Irene Adler.</p>
                <p>All emotions, and that one particularly, were abhorrent to
                    his cold, precise but admirably balanced mind. He was, I
                    take it, the most perfect reasoning and observing machine
                    that the world has seen, but as a lover he would have placed
                ...
                <p>At three o’clock precisely I was at Baker Street, but Holmes
                    ...
                    awaiting him, however long he might be.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Text-level elements are used for displaying content which
                    needs strong importance (<code>strong</code>) or stressed
                    emphasis (<code>em</code>).</p>

            </div>
            <div class="group__item group__item--primary">

                <p>To Sherlock Holmes she is <strong>always the woman</strong>.
                    I have seldom heard him mention her under any other name. In
                ...
                <p>All emotions, and <em>that one particularly</em>, were
                    ...
                    the softer passions, save with a gibe and a sneer.</p>
                <p>At three o’clock precisely I was at <a href="googlemap">Baker
                        Street</a>, but Holmes had not yet returned. The
                    landlady informed me that he had left the house shortly
                    after eight o’clock in the morning. I sat down beside the
                    fire, however, with the intention of awaiting him, however
                    long he might be.</p>
    ...
    <section>
        ...
        <div class="group">
            <div class="group__item">
                ...
                <h4 id="banner" class="heading size--xl no-margin">Hero</h4>
            ...
            <div class="group__item group__item--primary">
                ...
                <figure class="banner" role="banner" data-apollo-name="Banner">
                    <img class="banner__image"
                         src="/assets/images/production/sherlock-banner.jpg"
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Breadcrumbs component is used for displaying where our
                    visitors are, within the hierarchy of our website.</p>
                ...
                <ol class="breadcrumbs" itemscope
                    ...
                    <li itemprop="itemListElement" itemscope
                        ...
                        <a href="http://www.domain.com/level-1/level-2"
                           itemprop="item"> <span itemprop="name">Level 2</span>
                        </a>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The call-to-action component is used to draw your visitors
                    attention and encourage them to act on your message.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <figure class="cta bg--primary padding--surround">
                    ...
                    <a href="link" class="button button--subtle"> <span>Call Mrs. Hudson today</span>
                        <svg class="icon">
                            <use xlink:href="#arrow-right"/>
                        </svg>
                    </a>
                ...
                <figure class="cta bg--subtle padding--surround">
                    ...
                    <p>At three o’clock precisely I was at Baker Street, but
                        Holmes had not yet returned.</p>
                    <a href="link" class="button button--secondary"> <span>Call Mrs. Hudson today</span>
                        <svg class="icon">
                            <use xlink:href="#arrow-right"/>
                        </svg>
                    </a>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Callout component is used for displaying emphasised
                    groups of content.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Collapsible component is used for displaying groups of
                    content that would otherwise appear daunting.</p>
                <p>We use jQuery to add the interactive parts and the ARIA
                    attributes.</p>
                <p>We are careful and don&rsquo;t overuse the Collapsible
                    component, as it increases interaction cost, cognitive load
                    and forces our visitors to activate options that may not be
                    the information they are looking for.</p>

            </div>
            <div class="group__item group__item--primary">

                <h5 class="heading size size--xl subheading">Collapsibles with
                    Javascript</h5>
                ...
                <div class="collapsibles js-collapsibles" data-apollo-name="Collapsibles">
                    ...
                    <div class="js-collapsible-content">
                        ...
                        <p>All emotions, and that one particularly, were
                            ...
                            reasoning and observing machine that the world has
                            seen, but as a lover he would have placed himself in
                            a false position. He never spoke of the softer
                            passions, save with a gibe and a sneer.</p>
                    </div>
                    <!-- / Section: collapsible: item -->
                    ...
                    <div class="js-collapsible-content">
                        ...
                        <p>I was already deeply interested in his inquiry, for,
                            though it was surrounded by none of the grim and
                            strange features which were associated with the two
                            crimes which I have already recorded, still, the
                            nature of the case and the exalted station of his
                            client gave it a character of its own.</p>
                    </div>
                    <!-- / Section: collapsible: item -->
                </div>
                <!-- / Collapsibles wrapper -->
                ...
                <h5 class="heading size size--xl subheading">Collapsibles
                    without Javascript</h5>

                <!-- Collapsibles wrapper -->
                <div class="collapsibles">

                    <!-- Section: collapsible: item -->
                    <h3 class="heading size--xl">A Scandal in Bohemia</h3>
                    <div class="">
                        <p>To Sherlock Holmes she is always the woman. I have
                            seldom heard him mention her under any other name.
                            In his eyes she eclipses and predominates the whole
                    ...
                    <!-- Section: collapsible: item -->
                    <h3 class="heading size--xl">The Red-Headed League</h3>
                    <div class="">
                        <p>At three o’clock precisely I was at Baker Street, but
                            Holmes had not yet returned. The landlady informed
                            me that he had left the house shortly after eight
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Column component is used for displaying content in
                    columns.</p>
                <p>We are careful and only use the Column component when it
                    helps readability as people struggle to read information
                    that isn&rsquo;t linear.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Form component is used for displaying form fields which
                    lets us collect information from our visitors.</p>
                <p>We use
                    <a href="http://dbushell.github.io/Pikaday/">Pikaday</a>,
                    JavaScript plugin, to enhance picking a date from a
                    calendar.</p>
                <p>We use <a href="http://parsleyjs.org/">Parsley</a>, a
                    JavaScript library, to handle client-side form validation.
                </p>
                <p>Using Pikaday and Parsley, we also add the interactive parts
                    and the ARIA attributes to make form completion as easy as
                    possible for people.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <form action="" class="padding--surround bg bg--subtle form js-validate-form">
                    ...
                    <div class="field-group">
                        <label for="select-input" class="field-label"> Country
                            <small>(Required)</small>
                    ...
                    <div class="field-group">
                        <label for="textarea-input" class="field-label">
                            ...
                            <small>(Required)</small>
                            <div class="field-description">
                                Please explain the problem you are having, we&rsquo;ll
                    ...
                    <fieldset class="field-group checkbox-group">
                        ...
                        <div class="field-description">
                            ...
                            and never give it out to a third-party.
                        </div>
                    ...
                    <fieldset class="field-group radio-group"
                        ...
                        <div class="field-description">
                            Radio options are easier to read and quicker to scan
                            when laid out one under the other instead of next to
                            each other.
                        </div>

                        <label for="radio-input"> <input id="radio-input"
                                                         name="radio-input"
                                                         class="input--radio"
                                                         value="data-value"
                                                         type="radio"
                        ...
                        <label for="radio-input2"> <input id="radio-input2"
                                                          name="radio-input"
                                                          class="input--radio"
                                                          value="data-value"
                                                          type="radio">
                    ...
                    <fieldset
                        ...
                        <div class="field-description">
                            We understand that different people enjoy books in
                            different ways, which is why we&rsquo;re giving you
                            lots of options.
                        </div>
                        ...
                        <div class="segmented-group">
                            ...
                            <label for="segmented-option-1"> <input
                                ...
                                <div class="segmented-label">
                                    <h2 class="size--l heading">Approachable
                                        option</h2>
                                    <div class="">Copy to explain this option in
                                        more detail.
                                    </div>
                                </div>
                            </label>
                            ...
                            <label for="segmented-option-2"> <input
                                        ...
                                        checked>
                                <div class="segmented-label">
                                    <h2 class="size--l heading">Bell curve
                                        option</h2>
                                    <div class="">Copy to explain this option in
                                        more detail.
                                    </div>
                            ...
                            <label for="segmented-option-3"> <input
                                        ...
                                        type="radio">
                                <div class="segmented-label">
                                    <h2 class="size--l heading">Expensive
                                        option</h2>
                                    <div class="">Copy to explain this option in
                                        more detail.
                                    </div>
                            ...
                            <label for="segmented-option-4"> <input
                                        ...
                                        type="radio">
                                <div class="segmented-label">
                                    <h2 class="size--l heading">Secondary
                                        options</h2>
                                </div>
                            </label>
                    ...
                    <div class="field-group">
                        <button type="submit" class="button button--primary size--xl">
                            Action-contextual label, i.e. not 'Submit'
                        </button>
                    </div>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The List component is used for displaying unordered and
                    ordered lists of content. The definition list is used for
                    displaying terms and their definition.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Media component is used for displaying is an image with
                    optional copy.</p>
                <p><strong>We always including an alternative text for the
                        image.</strong>. If the image can&rsquo;t be displayed,
                    e.g. it might fail to load or our visitors are using
                    <abbr title="Assistive technology">AT</abbr> such as a
                    screen reader, this text is used to provide alternative
                    information to our visitors.</p>
                <p>We keep this <strong>under 150 characters</strong> so that
                    <abbr>AT</abbr>, such as JAWS, can read out all of it.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <h4 class="heading size--xl subheading">Media (right on
                    lap)</h4>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Metadata component is used for displaying information
                    about other data, e.g. a timestamp for a news item.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Navigation component is used for displaying primary and
                    secondary navigation links.</p>
                ...
                <nav class="nav nav--primary" data-apollo-name="Navigation">
                    <ul class="nav-list inline-list">
                        <li><a href="javascript:void(0)">
                                <img src="/assets/images/production/logo.png"
                                     alt="Logo name"> </a></li>
                    ...
                    <ul class="clean-list bg bg--subtle padding--surround">
                        ...
                        <li><a href="javascript:void(0)">A Case of Identity</a>
                            <ul class="">
                                ...
                                <li><a href="javascript:void(0)">The Red-Headed
                                        League</a></li>
                                <li><a href="javascript:void(0)">A Case of
                                        Identity</a>
                                </li>
                                <li><a href="javascript:void(0)">The Boscombe
                                        Valley Mystery</a></li>
                                <li><a href="javascript:void(0)">The Five Orange
                                        Pips</a></li>
                                <li><a href="javascript:void(0)">The Man with
                                        the Twisted Lip</a></li>
                            </ul>
                        </li>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Note component is used for displaying copy which needs
                    more attention.</p>
                <p>We reserve the use of Notes components for really important
                    information which benefits our visitors. If abused, they
                    will ignore it.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <div class="note" aria-label="Information" data-apollo-name="Notes">
                    ...
                    <p>At three o’clock precisely I was at <a
                        ...
                        that he had left the house shortly after eight o’clock
                        in the morning.</p>
                </div>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Pager component is used for displaying links to previous
                    and next pages.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Pagination component is used for displaying links to a
                    sequence of pages.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <ul class="inline-list pagination" role="navigation"
                    ...
                    <li class="pagination__item">
                        <a href="#">
                            <span class="visuallyhidden">Page</span>1<span
                                    class="visuallyhidden">of 123</span> </a>
                    </li>
                    <li class="pagination__item">
                        <span>&hellip;</span>
                    </li>
                    ...
                    <li class="pagination__item">
                        <a href="#" rel="prev"> <span class="visuallyhidden">Page</span>41<span
                                    class="visuallyhidden">of 123</span> </a>
                    </li>
                    <li class="pagination__item">
                    ...
                    <li class="pagination__item">
                        <a href="#" rel="next"> <span class="visuallyhidden">Page</span>43<span
                                    class="visuallyhidden">of 123</span> </a>
                    </li>
                    <li class="pagination__item">
                        <a href="#">
                    ...
                    <li class="pagination__item">
                        <a href="#"> <span class="visuallyhidden">Page</span>123<span
                                    class="visuallyhidden">of 123</span> </a>
                    </li>
                </ul>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Quote component is used for displaying content which is
        ...
        <div class="group">
            <div class="group__item">
                ...
                <h3 class="small-caps">Components</h3>
                <h4 id="share" class="heading size--xl no-margin">Share
                    &#10004;</h4>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Share component is used for displaying a list of social
                    sharing links, allowing our visitors to easily share the
                    page they are viewing.</p>
                <p>People also copy and paste the URL from the address bar so we
                    make sure our URLs are short, memorable, hackable and
                    people-centered.</p>
                ...
                <div class="share" data-apollo-name="Share">
                    <a href="#share-this"
                       ...
                       aria-haspopup="true">
                        ...
                        <span class="share__share-text">Share this</span> </a>
                    ...
                    <div class="share__panel js-share__panel"
                        ...
                        <p class="heading size--xl share__title" aria-hidden="true">
                            Share this with</p>
                            ...
                            <li class="share__channel share__channel--email">
                                <a class="share__channel-link"
                                   href="mailto:?subject={SUBJECT}&amp;body={URL}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">Email</span>
                            ...
                            <li class="share__channel share__channel--facebook">
                                <a class="share__channel-link"
                                   href="https://www.facebook.com/sharer/sharer.php?u={URL}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">Facebook</span>
                            ...
                            <li class="share__channel share__channel--twitter">
                                <a class="share__channel-link"
                                   href="https://twitter.com/intent/tweet?text={TEXT}&amp;url={URL}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">Twitter</span>
                            ...
                            <li class="share__channel share__channel--pinterest">
                                <a class="share__channel-link"
                                   href="https://uk.pinterest.com/pin/create/bookmarklet/?url={URL}&amp;description={DESCRIPTION}&amp;title={TITLE}&amp;media={IMAGE}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">Pinterest</span>
                            ...
                            <li class="share__channel share__channel--whatsapp">
                                <a class="share__channel-link"
                                   href="whatsapp://send?text={TEXT - URL}%3Focid%3Dwsnews.chat-apps.in-app-msg.whatsapp.trial.link1_.auin">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">WhatsApp</span>
                            ...
                            <li class="share__channel share__channel--linkedin">
                                <a class="share__channel-link"
                                   href="https://www.linkedin.com/shareArticle?mini=true&url={URL}&title={TITLE}&summary={SUMMARY optional}&source={SOURCE optional}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">LinkedIn</span>
                            ...
                            <li class="share__channel share__channel--google-plus">
                                <a class="share__channel-link"
                                   href="https://plus.google.com/share?url={URL}">
                                    ...
                                    <span class="share__channel-label" aria-hidden="true">Google +</span>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>We use
                    <a href="https://www.filamentgroup.com/lab/tablesaw.html">Tablesaw</a>,
                    a group of jQuery plugins, to manage tables in a responsive
                    layout.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Tabs component is used for displaying grouped content. We
                    use Tabs to alternate between views within the same context,
                    not to navigate to different areas.</p>
                <p>We use jQuery to add the interactive parts and the ARIA
                    attributes.</p>
                <p>We are careful and don&rsquo;t overuse the Tabs components.
                    If people need to compare the info behind different tabs,
                    then it&rsquo;s better to put everything on one big
                    page.</p>
            ...
            <div class="group__item group__item--primary">
                ...
                <h5 class="heading size size--xl subheading">Tabs with
                    Javascript</h5>
                ...
                <h5 class="heading size size--xl subheading">Tabs without
                    Javascript</h5>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Taxonomy component is used for displaying a list of
                    related links through our taxonomies.</p>
        ...
        <div class="group">
            <div class="group__item group__item--secondary">
                ...
                <p>The Video component is used for displaying moving visual
                    images. It supports third-party content from e.g. Youtube or
                    Vimeo.</p>
